...
namespace Ishop.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            /* var code = await UserManager.GenerateChangePhoneNumberTokenAsync(User.Identity.GetUserId(), model.em);
            ...
            try
            {
                ...
                oMail.Subject = "Profile Update";
                oMail.TextBody = "Profile updated to the following " +
